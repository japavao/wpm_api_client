...
class Script:
    ...
    def delete(self):
        """Deletes the given script, stopping it from scripting and removing all its scripting
        data."""
        if self.id is None:
            raise Exception("Missing id: This API requires a script ID be supplied.")
